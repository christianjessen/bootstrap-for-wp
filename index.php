...
?>
	...
	<?php if(have_posts()) : ?>
		...
		<p class="timestamp"><?php _e('Written by', 'bootstrap-for-wp'); ?> <?php the_author_meta("first_name"); ?> <?php the_author_meta("last_name"); ?> - <?php the_date() ?> @ <?php the_time() ?> - <?php comments_popup_link('Comment on this &#187;', '1 Comment &#187;', '% Comments &#187;'); ?></p>
